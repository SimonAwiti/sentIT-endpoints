...
@version1pstatus_bp.route('/<string:sender_name>', methods=['GET'])
def get_parcel_order_by_sender(sender_name, **kwargs):
    """getting sale record by name of sender"""
    data = ParcelObject.get_parcel_by_user(sender_name)
    return data
